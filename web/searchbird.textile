...
<pre>
scala> import brigade.searchbird.Client
import brigade.searchbird.Client
...
Typing "run" in the sbt console calls @main@, which configures and instantiates this server.
