...
** compose
** andThen
* "Case Statements":#casestatements
...
h2(#casestatements). Case Statements

h3. So just what are case statements?

It's a subclass of function called a PartialFunction.

h3. What is a collection of multiple case statements?
...
Define a case class <code>AlignmentStats</code> which contains a positions aligned count and a positions misaligned count. Use the <code>collect</code> combinator to transform a <code>Seq[AlignmentStats]</code> into a Seq of alignment percentages if the alignment is > 60.
