...
Write a function that uses pattern matching to print the brand of a <code>Calculator</code> if it's one of "hp", "ti", or "casio". If it's none of those, print an error message. Use the following definition of <code>Calculator</code>:
