...
Values and functions cannot be outside of a class or object.  Objects are a useful tool for organizing static functions and fields.
...
Now you can access the members directly. Note that static values are formatted as capitalized camel-case.
...
Write a function that uses pattern matching to print the name of the name of a <code>Calculator</code> if it's one of "hp", "ti", or "casio". If it's none of those, print an error message. Use the following definition of <code>Calculator</code>:
