...
Create a spec in your project to test the very trivial <code>AlignmentStringService</code> defined below:
...
Use a mock to mock out <code>AlignmentClient</code>, and write a couple of expectations using different matchers. Make sure the tests pass by running <code>mvn test</code>.
